...
import static com.ploy.bubble_server_v3.domain.user.domain.vo.WashingRoom.B31;
...
class UserReaderTest {
    ...
    void findById_success() {
        // given
        Users user = new Users(1L, "hashedPassword", "한태영", 1234, "test@example.com", "B304", B31, Role.USER);
